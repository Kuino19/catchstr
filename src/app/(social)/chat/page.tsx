            ...
            <header className="pt-12 pb-4 px-5 bg-background-light dark:bg-background-dark z-10 sticky top-0">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/live/studio" className="flex items-center justify-center w-10 h-10 rounded-full bg-red-500/10 text-red-500 hover:bg-red-500/20 transition-colors shadow-sm shadow-red-500/20" title="Go Live">
