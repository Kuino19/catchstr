            ...
            <main className="flex-1 flex flex-col p-4 overflow-y-auto no-scrollbar pb-24">
                ...
                {!previewUrl ? (
                    <div
                        ...
                        className="mt-4 flex flex-col items-center justify-center border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-2xl p-10 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                    >
